...
1.  **Clone the Repository**:
    ```bash
    git clone https://github.com/Sheentee/NavigationSimulator-Chrome.git
    ```
...
4.  **Load Unpacked**:
    Click the **Load unpacked** button and select the `NavigationSimulator` folder from your local machine.
